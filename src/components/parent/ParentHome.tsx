      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.headerRow}>
          ...
          <Pressable
            ...
            style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: parentColors.pillNeutralBg, alignItems: 'center', justifyContent: 'center' }}
            hitSlop={8}
          >
            <Ionicons name="chatbubble-ellipses-outline" size={18} color={parentColors.blue} />
          </Pressable>
        </View>
