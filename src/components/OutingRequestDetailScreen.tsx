          ...
          <>
            <Card>
              <View style={styles.headerRow}>
                ...
                <StatusPill label={outingRequestStatusMeta(request.state).label} />
              </View>
...
const styles = StyleSheet.create({
  ...
  studentName: { fontSize: 18, fontFamily: 'PlusJakartaSans_800ExtraBold', color: hostelWardenColors.ink, flex: 1 },
  rowLabel: {
    fontSize: 11.5,
    fontFamily: 'PlusJakartaSans_800ExtraBold',
    color: hostelWardenColors.muted,
    letterSpacing: 0.5,
    textTransform: 'uppercase',
  },
  rowValue: { fontSize: 14.5, fontFamily: 'PlusJakartaSans_600SemiBold', color: hostelWardenColors.ink, marginTop: 3 },
  ...
  rejectButtonText: { color: hostelWardenColors.red, fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 15 },
  approveButton: { flex: 1, borderRadius: 14, paddingVertical: 15, alignItems: 'center', backgroundColor: hostelWardenColors.primary },
