...
type TabKey = 'home' | 'school' | 'academics' | 'bus' | 'hostel' | 'gate' | 'dashboard' | 'ledger' | 'history' | 'students' | 'profile';
...
export function BottomTabBar() {
  ...
  const { isFaculty, isHostelWarden, isPrincipal, isVicePrincipal, isCommunity, isSportsAdmin, isCanteenVendor, isDriver } =
    useCurrentRoles();
  const TABS = isDriver
    ? DRIVER_TABS
    : isCanteenVendor
