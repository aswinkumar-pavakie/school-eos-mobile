// Vice Principal -> Library (Phase 16) -- real backend data only, a single
// overview screen by deliberate design (see vice-principal-library-api.ts's
...
// parent vice-principal/_layout.tsx.
...
import { getLibraryOverview, type LibraryOverview } from '@/lib/vice-principal-library-api';
...
export default function VicePrincipalLibraryScreen() {
  const router = useRouter();
  const overviewQuery = useQuery({ queryKey: ['vp-library', 'overview'], queryFn: getLibraryOverview });
