// Principal -> Apply for leave -- creates a REAL leave request via
// POST /staff/me/leave-requests, which routes through the existing generic
// approvals engine using the already-configured STAFF_LEAVE_REQUEST policy
// (single step, PRINCIPAL -- see principal-my-leave-api.ts's own comment for
// the disclosed self-approval caveat this implies for the Principal
// specifically). Real leave types only (CASUAL/MEDICAL/EARNED/ON_DUTY, the
// table's own CHECK constraint) -- no invented categories.
...
export default function PrincipalApplyLeaveScreen() {
