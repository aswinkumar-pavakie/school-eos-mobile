...
import {
  ...
  type PermissionRequestListItem,
  type PermissionRequestState,
} from '@/lib/permission-requests-api';
        ...
        {requestsQuery.isLoading ? (
          ...
          (requestsQuery.data ?? []).map((r: PermissionRequestListItem) => (
            <Pressable
              ...
              onPress={() => router.push(`/permissions/${r.id}` as never)}
            >
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.cardMeta} numberOfLines={1}>
                  ...
                  {[r.gradeName, r.sectionName].filter(Boolean).join(' ') || 'Class not assigned'}
                </Text>
                <Text style={styles.cardDate} numberOfLines={1}>
                  Requested {formatDate(r.addedAt)}
                </Text>
