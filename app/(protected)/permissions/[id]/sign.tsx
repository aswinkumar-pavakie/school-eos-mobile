...
export default function SignScreen() {
  ...
  async function handleApprove() {
    ...
    try {
      ...
      router.replace(`/permissions/${id}` as never);
    } catch (err) {
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.card, cardShadow]}>
          <Text style={styles.instructions}>
            By signing below, you confirm that you are the parent/guardian of this student and consent to their
        ...
        <Pressable
          style={[styles.approveButton, (!hasSignature || submitting) && styles.approveButtonDisabled]}
